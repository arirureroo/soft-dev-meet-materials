...
export const enrollmentDao = {
  ...
  findByStudentId: (studentId) => stmts.findByStudentId.all({ studentId }),

  findByCourseId: (courseId) => stmts.findByCourseId.all({ courseId }),

  totalCreditsByStudent: (studentId) => stmts.totalCreditsByStudent.get({ studentId }).total,
